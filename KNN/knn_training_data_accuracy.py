...
if __name__ == "__main__":
    ...
    for l in range(1000, 51000, 1000):
        ...
        parser.add_argument('--limit', type=int, default=l, help="Restrict training to this many examples")
        ...
        Accuracy[l/1000 - 1] = knn.accuracy(confusion)       
        print("Accuracy: %f" % knn.accuracy(confusion))

    numpy.savetxt('training_data_accuracy.txt', Accuracy)
