...
if __name__ == "__main__":
	...
	data = ThreesAndEights("/Users/yawen/Desktop/CSCI 5622 Machine Learning/Homework 3/SVM/data/mnist.pkl.gz")
	...
	print clf.score(data.x_train, data.y_train)
	print clf.score(data.x_test, data.y_test)
